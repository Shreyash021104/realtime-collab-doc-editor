...
// signup -> create doc -> share -> collaborative typing flow against the
// locally running dev servers, and saves screenshots so I can inspect the
// real rendered UI instead of just trusting that it compiles.
